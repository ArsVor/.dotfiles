...
vim.o.linebreak = true -- Companion to wrap, don't sp;it words (default: false)
vim.o.mouse = 'a' -- Enable mous mod (default: '')
vim.o.autoindent = true -- Copy indent from current line then stsrting new one (default: true)
